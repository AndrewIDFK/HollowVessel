...
namespace HollowVessel.Projectiles.Nails.BrokenNail
{
    public class BrokenNail : ModProjectile
    {
  		...
  		public override void OnHitNPC(NPC target, int damage, float knockBack, bool crit)
		{
            ...
            {
		        player.velocity.Y = Math.Abs(player.velocity.Y) < 3 ? -3 * player.gravDir : -player.velocity.Y;
