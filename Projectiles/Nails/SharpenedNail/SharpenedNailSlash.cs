...
{
    public class SharpenedNailSlash : ModProjectile
    {
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Sharpened Nail Slash");
  		...
  		public override void OnHitNPC(NPC target, int damage, float knockBack, bool crit)
		{
            ...
            {
		        player.velocity.Y = Math.Abs(player.velocity.Y) < 10 ? -10 * player.gravDir : -player.velocity.Y;
