...
namespace HollowVessel.Projectiles.Nails.SharpenedNail
{
    public class SharpenedNail2 : ModProjectile
    {
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Sharpened Nail 2");
            ...
            if (channeling)
            {
                ...
                if (projectile.ai[0] >= 40 && projectile.ai[0] < 120)
                {
					...
					for (int i = 0; i < 12; i++) 
					{
						...
						/*if(Timer > 5)
						{
							Main.dust[numDust].velocity = new Vector2(1f, 1f);
							Timer = 0;
						}*/
           ...
           /* else
            {
                ...
                Projectile.NewProjectile(pos.X, pos.Y, projectile.velocity.X, projectile.velocity.Y, mod.ProjectileType("OldNail2"), projectile.damage, projectile.knockBack, projectile.owner);
