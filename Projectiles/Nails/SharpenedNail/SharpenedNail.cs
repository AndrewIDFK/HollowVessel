    ...
    public class SharpenedNail : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
			...
			else if(projectile.ai[0] > 120)
            {
                ...
                Projectile.NewProjectile(pos.X, pos.Y, projectile.velocity.X * 2, projectile.velocity.Y * 2, mod.ProjectileType("SharpenedNailSlash"), projectile.damage * 10, projectile.knockBack * 6, projectile.owner);
            }
        }
    }
}