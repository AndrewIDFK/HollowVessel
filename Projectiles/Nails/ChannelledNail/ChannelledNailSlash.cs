...
{
    public class ChannelledNailSlash : ModProjectile
    {
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Channelled Nail Slash");
  		...
  		public override void OnHitNPC(NPC target, int damage, float knockBack, bool crit)
		{
            ...
            {
		        player.velocity.Y = Math.Abs(player.velocity.Y) < 9 ? -9 * player.gravDir : -player.velocity.Y;
