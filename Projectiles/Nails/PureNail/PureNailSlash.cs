...
{
    public class PureNailSlash : ModProjectile
    {
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Pure Nail Slash");
  		...
  		public override void OnHitNPC(NPC target, int damage, float knockBack, bool crit)
		{
            ...
            {
		        player.velocity.Y = Math.Abs(player.velocity.Y) < 11 ? -11 * player.gravDir : -player.velocity.Y;
