...
namespace HollowVessel.Projectiles.Nails.PellucidNail
{
    public class PellucidNail2 : ModProjectile
    {
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Pellucid Nail 2");
        ...
        public override void Kill(int timeLeft)
        {
			...
			else if(projectile.ai[0] > 120)
            {
				if(player.GetModPlayer<HollowPlayer>().dashSlashTimer >= 1)
				{
					...
					Projectile.NewProjectile(pos.X, pos.Y, player.direction, 0, mod.ProjectileType("PellucidDashSlash"), projectile.damage * 12, projectile.knockBack * 8, projectile.owner);
				...
				else
				{
					...
					Projectile.NewProjectile(pos.X, pos.Y, projectile.velocity.X * 2, projectile.velocity.Y * 2, mod.ProjectileType("PellucidNailSlash"), projectile.damage * 10, projectile.knockBack * 6, projectile.owner);
				}
            }
        }
    }
